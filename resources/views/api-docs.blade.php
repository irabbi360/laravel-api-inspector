            ...
            template: `
                <div class="topbar">
                    <div class="topbar-content">
                        <div class="api-info">
                            <div>
                                <div class="api-title">@{{ apiInspector?.title || 'Laravel API Inspector' }} 
                                    <a href="https://github.com/irabbi360/laravel-api-inspector" target="_blank">
                                        <svg
                                                width="30"
                                                height="30"
                                                viewBox="0 0 98 98"
                        ...
                        <div class="topbar-actions">
                            ...
                            <a href="https://github.com/irabbi360/laravel-api-inspector/issues/new" target="_blank" class="btn" style="background: #389f71ff;">Feature Request</a>
                        </div>
                    </div>
                </div>
            `,
                ...
                formatSchema(schema) {
                    ...
                    Object.keys(schema).forEach(key => {
                        ...
                        if (
                            ...
                            obj[key] = this.formatSchema(field.schema);
                        }
                        else if (typeof field === 'object' && field !== null) {
                            obj[key] = this.formatSchema(field);
                        }
                        else {
                            obj[key] = field;
                        }
